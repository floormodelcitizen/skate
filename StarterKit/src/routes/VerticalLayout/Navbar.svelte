      ...
      <ul class="metismenu list-unstyled" id="side-menu">
        ...
        <li>
          ...
          >
            ...
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-saas"
            ...
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-blog"
        ...
        <li class={current == "ecommerce" ? "mm-active" : ""}>
          ...
          >
            ...
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-cart"
            ...
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-shops"
        ...
        <li class={current == "crypto" ? "mm-active" : ""}>
          ...
          >
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-wallet"
                >{$_("menuitems.crypto.list.wallet")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-buy"
            ...
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-orders"
        ...
        <li class={current == "email" ? "mm-active" : ""}>
          ...
          >
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-inbox"
                >{$_("menuitems.email.list.inbox")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-read-email"
        ...
        <li class={current == "projects" ? "mm-active" : ""}>
          ...
          >
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-p-grid"
                >{$_("menuitems.projects.list.grid")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-p-list"
        ...
        <li class={current == "tasks" ? "mm-active" : ""}>
          ...
          >
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-task-list"
        ...
        <li class={current == "blog" ? "mm-active" : ""}>
          ...
          >
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-blog-list"
                >{$_("menuitems.blog.list.bloglist")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-blog-grid"
        ...
        <li class={current == "authentication" ? "mm-active" : ""}>
          ...
          >
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-login"
                >{$_("menuitems.authentication.list.login")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-login-2"
        ...
        <li class={current == "utility" ? "mm-active" : ""}>
          ...
          >
            ...
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-faqs"
                >{$_("menuitems.utility.list.faqs")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-pricing"
                >{$_("menuitems.utility.list.pricing")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-error-404"
                >{$_("menuitems.utility.list.error404")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-error-500"
        ...
        <li class={current == "uielements" ? "mm-active" : ""}>
          ...
          >
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-alerts"
                >{$_("menuitems.uielements.list.alerts")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-buttons"
                >{$_("menuitems.uielements.list.buttons")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-cards"
                >{$_("menuitems.uielements.list.cards")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-carousel"
            ...
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-grid"
                >{$_("menuitems.uielements.list.grid")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-images"
                >{$_("menuitems.uielements.list.images")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-modals"
            ...
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-toast"
                >{$_("menuitems.uielements.list.toast")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-video"
                >{$_("menuitems.uielements.list.video")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-general"
                >{$_("menuitems.uielements.list.general")}</Link
              >
            </li>
            <li>
              <Link class="side-nav-link-ref" to="/" key="t-colors"
